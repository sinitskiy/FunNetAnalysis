    ...
    for filename in files:
        ...
        try:
            with open(txt_file_path, 'r', encoding='utf-8') as f:
                ...
                continue
        for protien in proteins_inthe_file:
            proteins_counts[protien] +=1 
...
def write_to_csv(inv_counts, invasive_total, non_inv_counts, non_invasive_total, output_file):
    ...
    with open(output_file, 'w', newline='') as csvfile:
        ...
        writer_to_csv.writerow([
            "protein name", "total count", "total fraction", 
        ...
        for protein in all_proteins:
            ...
            writer_to_csv.writerow([
                protein, total_count, round(total_fraction, 5), 
...
if __name__ == '__main__':
    stageIII_folder = "/CourseProject/StageIII_protein_list"  # Make sure to Update this path with your local one
    stageI_folder = "/CourseProject/StageI_protein_list" # Make sure to Update this path with your local one
